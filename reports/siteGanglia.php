...
<table width="1200" height="50" border="0" class="Estilo11">
  <tr>
     ...
     <input type="radio" name="option" value="analyzer" checked="true">Time: <select name="time"></strong>
     ...
     <br><input type="radio" name="option" value="reports">Range: 
     Start Date:  <input type="text" class="form-control" id="start-date-datepicker" name="from">
     End Date:  <input type="text" class="form-control" id="end-date-datepicker" name="until">
...
<table width="1000" border="0">
  <tr>
    ...
    <td width="170" align="center" valign="top">
        ...
        onClick="mainform.submit();"><?php echo "Ganglia Graph"; ?>
    </td>
...
<table width="1270" height="130" border="0">
  <tr>
    ...
    if(isset($host_array)&&sizeof($host_array)>1){
      if ($option == "analyzer"){
        gangliaGraph($site, $source, $option, $time,NULL);
      }
      elseif ($option == "reports"){
        gangliaGraph($site, $source, $option, $from, $until);
      }
